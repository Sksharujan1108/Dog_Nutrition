              ...
              tabBarIcon: ({ color }) => (
                <View style={styles.iconView}>
                  {color == ColorSheet.Secondary ? (
                    <GreenHome fill={color} width={26} height={26} />
                  ) : (
                    <Home fill={color} width={26} height={26} />
                  )}
                  <Text
                    style={[
                      styles.labelText,
          ...
          <Tab.Screen
            ...
            options={() => ({
              tabBarIcon: ({ color }) => (
                <View style={styles.iconView}>
                  {color == ColorSheet.Secondary ? (
                    <GreenSearch width={26} height={26} />
                  ) : (
                    <Search
                      // fill={color}
                      width={26}
          ...
          <Tab.Screen
            ...
            options={() => ({
              tabBarIcon: ({ color }) => (
                ...
                >
                  {color == ColorSheet.Secondary ? (
                    <GreenCart fill={color} width={31} height={29} />
                  ) : (
                    <Cart fill={color} width={31} height={29} />
                  )}
                  <Text
                    style={[
                      styles.labelText,
          ...
          <Tab.Screen
            ...
            options={() => ({
              tabBarIcon: ({ color }) => (
                <View style={styles.iconView}>
                  {color == ColorSheet.Secondary ? (
                    <GreenGuide fill={color} width={26} height={26} />
                  ) : (
                    <Guide fill={color} width={26} height={26} />
                  )}
                  <Text
                    style={[
                      styles.labelText,
          ...
          <Tab.Screen
            ...
            options={() => ({
              tabBarIcon: ({ color }) => (
                <View style={styles.iconView}>
                  {color == ColorSheet.Secondary ? (
                    <GreenProfile fill={color} width={26} height={26} />
                  ) : (
                    <Profile fill={color} width={28} height={28} />
                  )}
                  <Text
                    style={[
                      styles.labelText,
